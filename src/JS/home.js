...
const wrapper_contact = document.querySelector(".estate-details__contact");
...
wrapper_detailview.addEventListener("click" , delegation_estate_detail);


function delegation_estate_detail(event){
    if(event.target.matches(".estate-details__btn")){
    
        wrapper_contact.classList.remove("toright");
        wrapper_contact.style.display="block";
        wrapper_contact.classList.add("toright");
    }
    if(event.target.matches(".estate-details__contact--btn")){
        wrapper_contact.classList.remove("toright");
    }
    if(event.target.matches(".estate-details__contact--close")){
        wrapper_contact.style.display="none";
        wrapper_contact.classList.remove("toright");
    }
...
/*  Objekte von API in Tabellenansicht laden
-------------------------------------------------------------- */
